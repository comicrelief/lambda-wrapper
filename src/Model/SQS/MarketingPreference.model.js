...
export default class MarketingPreference extends Model {
  ...
  constructor(data = {}) {
    ...
    this.instantiateFunctionWithDefinedValue('setFirstName', typeof data.firstName !== 'undefined' && data.firstName !== '' ? data.firstName : data.firstname);
    this.instantiateFunctionWithDefinedValue('setLastName', typeof data.lastName !== 'undefined' && data.lastName !== '' ? data.lastName : data.lastname);
