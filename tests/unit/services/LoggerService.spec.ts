...
describe('unit.services.LoggerService', () => {
  ...
  describe('error', () => {
    ...
    it('should send the error to Sentry, if enabled', () => {
      ...
      // suppress log messages generated by this test
      jest.spyOn(Winston.Logger.prototype, 'log').mockImplementation(jest.fn());
    ...
    it('should send the error to Dash0, if enabled', () => {
      const errorSpy = jest.spyOn(Dash0Telemetry.prototype, 'error').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry.prototype, 'tag').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry.prototype, 'label').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry, 'isEnabled', 'get').mockReturnValue(true);
      // suppress log messages generated by this test
      jest.spyOn(Winston.Logger.prototype, 'log').mockImplementation(jest.fn());
  ...
  describe('label', () => {
    ...
    it('should send the label to Dash0, if enabled', () => {
      const labelSpy = jest.spyOn(Dash0Telemetry.prototype, 'label').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry.prototype, 'tag').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry, 'isEnabled', 'get').mockReturnValue(true);
      // suppress log messages generated by this test
      jest.spyOn(Winston.Logger.prototype, 'log').mockImplementation(jest.fn());
  ...
  describe('metric', () => {
    ...
    it('should send the tag to Dash0, if enabled', () => {
      const tagSpy = jest.spyOn(Dash0Telemetry.prototype, 'tag').mockImplementation(jest.fn());
      jest.spyOn(Dash0Telemetry, 'isEnabled', 'get').mockReturnValue(true);
      // suppress log messages generated by this test
      jest.spyOn(Winston.Logger.prototype, 'log').mockImplementation(jest.fn());
