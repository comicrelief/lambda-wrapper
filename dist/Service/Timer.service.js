 ...
 * TimerService class
 */
var TimerService = /*#__PURE__*/function (_DependencyAwareClass) {
  ...
  _createClass(TimerService, [{
    ...
    value: function stop(identifier) {
      if (typeof this.timers[identifier] !== 'undefined') {
        ...
        this.getContainer().get(_Dependencies.DEFINITIONS.LOGGER).info("Timing - ".concat(identifier, " took ").concat(duration, "ms to complete"));
      }
    }
  }]);
